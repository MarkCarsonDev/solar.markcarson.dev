footer_html = \
    f'<div id="footer">\
        <div class="icons">\
            <a href="https://www.linkedin.com/in/markcarsondev" target="_blank" id="linkedin">\
            ...
            <a href="https://github.com/MarkCarsonDev" target="_blank" id="github">\
        ...
        <footer>Built from scratch in 2024 using HTML5 and Python.\
            <br>Generated using <a>Sonne</a>, my static-site generator\
            <br>Designed to be efficient, fast, and accessible.\
        </footer>\
    </div>'
